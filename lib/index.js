...
export default function indexr(...args) {
  ...
  return watcher(() => {
    ...
    return output;
  }, watchGlobs, ignoredGlobs);
}

// TODO: Refactor to modules

// parseCli - process.argv
// parseArgs - inputFolder, outputFilename, options
// optionWatch - parsedArgs
// optionModuleFolders
// optionSubmodules
// optionExts
// optionDirectImport
...
/*
// Some kind of overarching structure like this
const app = waterfall([
  parseCLI,
  parseArgs,
  optionWatch
